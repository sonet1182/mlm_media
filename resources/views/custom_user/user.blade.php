                ...
                <form action="{{ route('user.user.list.user') }}" method="post">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="customer_contact_number" class="form-label">Customer Contact Number:</label>
                                    <input type="text" name="customer_contact_number" value="{{old('customer_contact_number')}}" id="" class="form-control"
                                        placeholder="Exp: 017........ (11 Digit Phone number)">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="customer_email" class="form-label">Customer Email ID:</label>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="sto_id" class="form-label">Stockiest Id:</label>
                                    <select name="stockiest_id" value="{{old('stockiest_id')}}" id="stockiest_id" class="form-control">
