<form id="updateForm" class="needs-validation" action="{{ route('admin.user.withdraw.update', $data->id) }}" method="POST" novalidate
    ...
    <div class="form-row">
        ...
        <div class="col-md-12 mb-3">
            <h4 class="text-center">Amount: {{ $data->amount }} /=</h4>
