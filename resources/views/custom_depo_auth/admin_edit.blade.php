...
<div class="col-lg-12">
  <div class="card">
    <div class="card-header"><h4>DEPO Update </h4></div>
    <div class="card-body">
        <form action="{{ route('depo.admin.edit.post') }}" method="post">
            @csrf
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <button type="submit" class="btn btn-primary">Update Depo</button>
                        </div>
                    </div>
                </div>
            </div>
