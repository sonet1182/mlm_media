...
@section('content')
    <div class="tree" style="width:100%">
        ...
        <ul>
            <li style="width:100%">
                <a data-toggle="tooltip" data-id="{{$referGroupAdmin->id}}" data-placement="top" title="Name: {{$referGroupAdmin->customer_name}}, ref_id:{{$referGroupAdmin->user_ref_id}}" href="{{ route('childTree', $referGroupAdmin->id) }}">
