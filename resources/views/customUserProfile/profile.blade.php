...
@include('layouts.session')
    ...
    <div class="card">
        <div class="card-body">
            <form id="bannerForm" class="needs-validation" action="{{ route('user.profile.update') }}" method="POST"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="mt-2" id="image-preview">
                            <image src="{{ asset($data->photo) }}" alt="" height="200px" width="200px"
    ...
    <div class="card card-default mt-3">
        <div class="card-body">
            ...
            <form id="passwordUpdateForm" class="needs-validation"
                action="{{ route('user.profile.update_password') }}" method="POST" novalidate>
                @csrf
